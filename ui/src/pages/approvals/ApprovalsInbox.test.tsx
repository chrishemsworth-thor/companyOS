...
describe("Awaiting me", () => {
  it("lists approvals of three types in one list with type-specific context", async () => {
    // The criterion. All three take the generic renderer in S4 — which is exactly
    // why "correct type-specific context" here means the right label, requester
    // and reference on each, not three different card layouts.
    awaiting = [
